...
#avem tabela users la inceput de script
...
def export_sqlite_to_sql(sqlite_db_file, output_sql_file, limit = 7000):
    ...
    with open(output_sql_file, 'w') as f:
        ...
        # Adaugam comanda de creare a tabelului Users
        ...
        # Adaugam insertiile pentru tabela Users
        users_inserts = [
        ...
        # Adaugam instructiunea DELETE pentru a sterge toate inregistrarile din tabela Users
        f.write('\n')
        f.write('DELETE FROM `Users`;\n')
        f.write('\n')

        # Adaugam insertiile specifice la final pentru tabela Users
        ...
        # Adaugam comanda de creare a tabelului Data
        ...
        # Iteram prin datele din fișierul CSV si adaugati inserarile in fisierul SQL
