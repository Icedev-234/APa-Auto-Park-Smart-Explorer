...
<body>
    <header>
        ...
        <ul class="navbar">
          <li><a href="../About Page/about.html"><i class='bx bx-question-mark'></i>About</a></li>
          <li><a href="../"><i class='bx bxs-contact' ></i>Contact</a></li>
          <li><a href=""><i class='bx bx-cog' ></i>Security and Policy</a></li>
          <li><a href="../Statistics Page/statistics.html" ><i class='bx bx-stats' ></i>Statistics</a></li>
      </ul>
        <a href="#" class="btn">
